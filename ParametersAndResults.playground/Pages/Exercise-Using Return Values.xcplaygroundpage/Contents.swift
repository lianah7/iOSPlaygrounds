...
let impossibleCountResult = impossibleBeliefsCount(pigsFlying: 11, frogsBecomingPrinces: 20, multipleLightningStrikes: 746)
print(impossibleThingsPhrase(numberOfImpossibleThings: impossibleCountResult, meal: "dessert"))
