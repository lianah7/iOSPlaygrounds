...
*/
func favorite(categoryOfThing: String, favorite: String) -> String {
...
let favoriteSong = favorite(categoryOfThing: "song", favorite: "Alone Again Naturally")
let favoriteMovie = favorite(categoryOfThing: "movie", favorite: "The Chronicles of Narnia")
let favoriteFood = favorite(categoryOfThing: "food", favorite: "pasta")
...
let introduction = "Hello, my name is Kevin. \(favoriteSong). \(favoriteMovie). \(favoriteFood)."
